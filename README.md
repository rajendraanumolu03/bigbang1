...
| global.appConfig.incomingEmail.deliveryMethod | string | `"sidekiq"` |  |
...
| global.appConfig.serviceDeskEmail.deliveryMethod | string | `"sidekiq"` |  |
...
| global.certificates.image.tag | string | `"14.10.1"` |  |
...
| global.kubectl.image.tag | string | `"14.10.1"` |  |
...
| postgresql.image.tag | string | `"12.9"` |  |
...
| registry.image.tag | string | `"14.10.1"` |  |
...
| gitlab.toolbox.image.tag | string | `"14.10.1"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"14.10.1"` |  |
...
| gitlab.migrations.image.tag | string | `"14.10.1"` |  |
...
| gitlab.webservice.image.tag | string | `"14.10.1"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"14.10.1"` |  |
...
| gitlab.sidekiq.image.tag | string | `"14.10.1"` |  |
...
| gitlab.gitaly.image.tag | string | `"14.10.1"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"14.10.1"` |  |
...
| gitlab.praefect.image.tag | string | `"14.10.1"` |  |
...
| minio.imageTag | string | `"RELEASE.2022-03-22T02-05-10Z"` |  |
...
| minio.minioMc.tag | string | `"RELEASE.2022-03-17T07-21-29Z"` |  |
