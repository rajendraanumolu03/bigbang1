...
| global.certificates.image.tag | string | `"15.3.2"` |  |
...
| global.kubectl.image.tag | string | `"15.3.2"` |  |
...
| registry.image.tag | string | `"15.3.2"` |  |
...
| gitlab.toolbox.image.tag | string | `"15.3.2"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"15.3.2"` |  |
...
| gitlab.webservice.image.tag | string | `"15.3.2"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"15.3.2"` |  |
...
| minio.imageTag | string | `"RELEASE.2022-09-07T22-25-02Z"` |  |
...
| minio.minioMc.tag | string | `"RELEASE.2022-08-28T20-08-11Z"` |  |
