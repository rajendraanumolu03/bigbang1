...
| global.certificates.image.tag | string | `"15.3.1"` |  |
...
| global.kubectl.image.tag | string | `"15.3.1"` |  |
...
| redis.metrics.image.tag | string | `"1.43.1"` |  |
...
| registry.image.tag | string | `"15.3.1"` |  |
...
| gitlab.toolbox.image.tag | string | `"15.3.1"` |  |
...
| gitlab.gitlab-exporter.image.tag | string | `"15.3.1"` |  |
...
| gitlab.migrations.image.tag | string | `"15.3.1"` |  |
...
| gitlab.webservice.image.tag | string | `"15.3.1"` |  |
...
| gitlab.webservice.workhorse.tag | string | `"15.3.1"` |  |
...
| gitlab.sidekiq.image.tag | string | `"15.3.1"` |  |
...
| gitlab.gitaly.image.tag | string | `"15.3.1"` |  |
...
| gitlab.gitlab-shell.image.tag | string | `"15.3.1"` |  |
...
| gitlab.mailroom.image.tag | string | `"15.3.1"` |  |
...
| gitlab.praefect.image.tag | string | `"15.3.1"` |  |
...
| minio.imageTag | string | `"RELEASE.2022-08-22T23-53-06Z"` |  |
...
| minio.minioMc.tag | string | `"RELEASE.2022-08-23T05-45-20Z"` |  |
